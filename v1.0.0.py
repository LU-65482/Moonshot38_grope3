...
#参数推荐范围调节效果
#Z_THRESHOLD-3.5 ~ -5.5负值越小，灵敏度越低
#BUFFER_SIZE5 ~ 10值越大，抗干扰能力越强
#DEBOUNCE_TIME1.5 ~ 3.0值越大，误报率越低
    ...
    def monitor_loop(self):
        ...
        try:
            while True:
                ...
                # 显示简化信息
                print(f"Z轴: {current_z:6.2f} 状态: {'正常' if current_z > Z_THRESHOLD else '急停'}".ljust(40), end='\r')
